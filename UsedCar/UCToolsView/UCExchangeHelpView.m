...
@implementation UCExchangeHelpView
...
- (void)initView{
    ...
    _vWeb = [[UCWebView alloc] initWithFrame:CGRectMake(0, _tbTop.maxY, self.width, self.height - _tbTop.maxY) withWebURL:[APIHelper getToolExchangeHelpWebURL]];
