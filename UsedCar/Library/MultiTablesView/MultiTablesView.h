...
- (NSString *)multiTablesView:(MultiTablesView *)multiTablesView slideLevel:(NSInteger)slideLevel titleForHeaderInSection:(NSInteger)section;
...
@interface MultiTablesView : UIView <UIGestureRecognizerDelegate>
...
@property (nonatomic, assign, readonly) UIView *currentVBcak;
...
@property (nonatomic, strong) NSArray *marginLifts;
