...
#define kBadgeStrokeColor [UIColor redColor]
...
{    
    ...
    self.badgeStrokeWidth = 3.0f;
    _MarginToDrawInside = self.badgeStrokeWidth * 2;
    self.shadowRadius = 1;
    self.badgeHeight = 16.0f;
    self.badgeTextSideMargin = 8;
...
{    
    ...
    CGFloat viewWidth = textWidth + self.badgeTextSideMargin + (_MarginToDrawInside * 2);
    CGFloat viewHeight = self.badgeHeight + (_MarginToDrawInside * 2);
...
-(void)setBadgeTextSideMargin:(CGFloat)badgeTextSideMargin
{
    if (badgeTextSideMargin != _badgeTextSideMargin) {
        _badgeTextSideMargin = badgeTextSideMargin;
    }
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (anyTextToDraw)
    {
        ...
        CGContextSaveGState(ctx);
        {
            ...
            CGContextSetShadowWithColor(ctx, kShadowOffset, self.shadowRadius, kShadowColor.CGColor);
        ...
        CGContextSaveGState(ctx);
        {
            ...
            CGContextSetLineWidth(ctx, _MarginToDrawInside);
        ...
        CGContextSaveGState(ctx);
        {
            ...
            [self.badgeText drawInRect:textFrame withFont:self.badgeTextFont lineBreakMode: NSLineBreakByCharWrapping alignment:NSTextAlignmentCenter];
        }
        CGContextRestoreGState(ctx);
    }
}
