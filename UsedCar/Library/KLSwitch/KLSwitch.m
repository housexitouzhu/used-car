...
-(void) setContrastLabelText:(NSString *)text;
-(void) setOnLabelText:(NSString *)text;
...
-(void) setContrastLabelText:(NSString *)text {
    [self.track setContrastLabelText:text];
}
-(void) setOnLabelText:(NSString *)text {
    [self.track setOnLabelText:text];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    [_thumb.layer setShadowColor: [kColorGrey3 CGColor]];
...
-(id) initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame: frame]) {
        ...
        _contrastLabel = [[UILabel alloc] initWithFrame:CGRectMake(contrastRect.size.height, 0, contrastRect.size.width - contrastRect.size.height - 12, contrastRect.size.height)];
        _contrastLabel.backgroundColor = [UIColor clearColor];
        _contrastLabel.textColor = kColorGrey3;
        _contrastLabel.textAlignment = NSTextAlignmentCenter;
        _contrastLabel.font = kFontNormal;
        [_contrastView addSubview:_contrastLabel];
        ...
        _onLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 0, contrastRect.size.width - contrastRect.size.height - 12, contrastRect.size.height)];
        _onLabel.backgroundColor = [UIColor clearColor];
        _onLabel.textColor = [UIColor whiteColor];
        _onLabel.textAlignment = NSTextAlignmentCenter;
        _onLabel.font = kFontNormal;
...
-(void) setContrastLabelText:(NSString *)text {
    [self.contrastLabel setText:text];
}

-(void) setOnLabelText:(NSString *)text {
    [self.onLabel setText:text];
}
